...
<head>
	...
	<script type="text/javascript">
		...
		function fnAddFile(){
			if(cnt == 0){
				$("#dFile").append("<br>"+"<input  type='file' name='mainImage' id='MainImage' />");
			}else{
				$("#dFile").append("<br>"+"<input  type='file' name='detailImage"+cnt+"' />");
			}
			cnt++;
		}
  
  
  function fnAddNewGoods(obj){
		 fileName = $('#MainImage').val();
	...
	<div class="tab_container" id="container">
			...
			<div class="tab_content" id="tab7">
				...
				<table >
					<tr>
						...
						<td  align="left"> <input type="button"  value="파일 추가" onClick="fnAddFile()"/></td>
						<td>
							<div id="dFile"></div>
						</td>
					</tr>
		...
		<center>
			<table>
				<tr>
					<td align=center>
						<input  type="button" value="상품 등록하기"  onClick="fnAddNewGoods(this.form)">
					</td>
				</tr>
			</table>
		</center>
